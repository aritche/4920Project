...
import {Container, Image, Menu, Popup} from 'semantic-ui-react';
  ...
  render() {
    ...
    return (
      <Menu inverted pointing secondary
            style={{backgroundColor: '#193446', boxShadow: '2px 1px 2px #000000', maxHeight: '45px'}}>
        <Container>
          <Menu.Item
            as={Link}
            to={homeUrl}
              ...
              <Menu.Menu position='right'>
                <Menu.Item style={{display: 'inline-block'}}>
                  <Popup
                    ...
                    trigger={<Image onClick={this.triggerUserPopup} style={{
                      width: "30px", height: '30px', marginLeft: 'auto', marginBottom: '-6px',
                      cursor: 'pointer'
                    }} src={'/images/avatar/' + this.state.avatar + '.jpg'}
                                    circular avatar/>}
                    content=
                      {
                        <UserPopup
