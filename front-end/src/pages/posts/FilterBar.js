...
import {Checkbox, Dropdown, Form, Header, Input, Menu, Segment} from 'semantic-ui-react';
      ...
      <Segment style={{paddingTop: 10, paddingBottom: 10, backgroundColor: "#193446"}}>
        <Menu secondary>
          ...
          <Dropdown text='Time Range'
            ...
            <Dropdown.Menu
              style={{
                paddingLeft: 25, paddingRight: 25, paddingBottom: 10, paddingTop: 10, width: "500px",
