...
import {emptyString, isPositiveFloat, isPositiveInteger, isZero} from '../../utils/ValidationUtils';
        ...
        <Modal.Content>
          <Form>
            <Form.Group widths='equal'>
              <Form.Field>
                <label>Name</label>
                <Form.Input fluid error={!this.nameValid()} placeholder='Item Name' value={this.state.name}
              ...
              <Form.Field>
                ...
                <Form.Input fluid placeholder='Item Amount' value={this.state.amount}
                            error={!isPositiveFloat(this.state.amount) || isZero(this.state.amount)}
                            onChange={(e) => this.onAmountChange(e.target.value)}/>
              </Form.Field>
            </Form.Group>
            <Header content={'Item Description'}/>
            <Form.Field error={emptyString(this.state.desc)} control={TextArea}
