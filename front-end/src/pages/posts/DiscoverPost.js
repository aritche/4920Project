...
import {Container, Grid, Header, Item, Label, Rating, Segment} from 'semantic-ui-react';
              ...
              <Grid.Row style={{padding: '0'}}>
                <Grid.Column textAlign='center' width={6} style={{padding: '0'}}>
                  ...
                  <Grid.Row>
                    ...
                    <Rating size={'medium'} icon='star' style={{marginLeft: '10px'}}
                            defaultRating={post.movee.rating_overall} maxRating={5} disabled/>
                    }
                  </Grid.Row>
                </Grid.Column>
