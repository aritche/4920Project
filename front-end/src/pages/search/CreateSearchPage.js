        ...
        <Segment inverted tertiary>
          <Menu secondary>
            ...
            <Menu.Menu position='right'>
              <h4>Sort by:</h4>
              <Dropdown selection onChange={this.onSortByChange} defaultValue={sortByOptions[0].value}
                        options={sortByOptions} compact floating labelled button/>
            </Menu.Menu>
          </Menu>
        </Segment>
        <Form onSubmit={this.onQuerySubmit}>
          <Form.Input icon='search' style={{minWidth: 400}} placeholder='Search posts' value={this.state.query}
